...
[![Tests](https://img.shields.io/badge/tests-393_total%2C_4_opt--in-brightgreen.svg)](docs/release-readiness.md)
...
| 验证项 | 结果 |
|---|---|
| Maven 全量测试 | **393** 个测试，零失败、零错误；4 个本机资产验收用例按设计默认跳过并已显式运行通过 |
